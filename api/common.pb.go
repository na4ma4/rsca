...
func (x *Message) GetRegisterMessage() *RegisterMessage {
	if x != nil {
		if x, ok := x.Message.(*Message_RegisterMessage); ok {
...
func (x *Message) GetPingMessage() *PingMessage {
	if x != nil {
		if x, ok := x.Message.(*Message_PingMessage); ok {
...
func (x *Message) GetPongMessage() *PongMessage {
	if x != nil {
		if x, ok := x.Message.(*Message_PongMessage); ok {
...
func (x *Message) GetEventMessage() *EventMessage {
	if x != nil {
		if x, ok := x.Message.(*Message_EventMessage); ok {
...
func (x *Message) GetTriggerAllMessage() *TriggerAllMessage {
	if x != nil {
		if x, ok := x.Message.(*Message_TriggerAllMessage); ok {
...
func (x *Message) GetRepeatRegistrationMessage() *RepeatRegistrationMessage {
	if x != nil {
		if x, ok := x.Message.(*Message_RepeatRegistrationMessage); ok {
...
func (x *Message) GetMemberUpdateMessage() *MemberUpdateMessage {
	if x != nil {
		if x, ok := x.Message.(*Message_MemberUpdateMessage); ok {
